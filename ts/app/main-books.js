(()=>{var r=class{url;constructor(e){this.url=e}getSheetData(){return fetch(this.url).then(e=>e.json()).catch(e=>(console.log("Could not get response from url:",e),{values:["shifted"]})).then(this.parseData)}parseData(e){let a=e.values;return a.shift(),a.map(t=>({isbn:t[0],title:t[1],author:t[2],publishingDate:t[3],theme:t[4],trigger:t[5],status:t[6],lendingDate:t[7].split("T")[0]}))}async getAndParseBooks(){return await this.getSheetData()}};var n="https://script.google.com/macros/s/AKfycbzSZC8h1J5219wrKfMRrR3KHrdYLFDOPVUZxUrm-TAvhaPRQfVnBe2gGbGOV0jyLjzOuQ/exec";var s=class{constructor(){}fillElement(e,a){if(a.length==0){e.innerHTML=this.generateWarningMessageIfEmptyBooks();return}e.innerHTML=this.generateTableElement(),new DataTable("#book-table",{data:a,columns:[{data:"isbn"},{data:"title",width:"30em"},{data:"author"},{data:"publishingDate"},{data:"theme"},{data:"trigger"},{data:"status",render:(t,i,c,p)=>`<span class="badge ${t=="disponible"?"bg-success":"bg-danger"}">${t}</span>`},{data:"lendingDate"}],language:{url:"https://cdn.datatables.net/plug-ins/1.13.4/i18n/fr-FR.json"}})}generateWarningMessageIfEmptyBooks(){return`<div class="alert alert-warning" role="alert">
